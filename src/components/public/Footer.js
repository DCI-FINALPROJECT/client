          ...
          <section className="footer-top padding-y">
            <div className="row">
              ...
              <aside className="col-sm-2  col-md-2">
                ...
                <a href="#" className="d-block mb-2"><img src="../images/misc/appstore.png" height="40"/></a>
                <a href="#" className="d-block mb-2"><img src="../images/misc/playmarket.png" height="40"/></a>
              </aside>
            </div>
          </section>
